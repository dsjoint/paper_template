\documentclass[onecolumn,11pt,a4paper,reqno]{article}
...
\usepackage[bookmarksnumbered,linktocpage,hypertexnames=false,colorlinks=false,linkcolor=blue,urlcolor=blue,citecolor=blue,anchorcolor=green,breaklinks=true,pdfusetitle]{hyperref}
...
\newcommand{\ToDo}[1]{ \textcolor{red}{\small (#1) \marginpar{\small\textcolor{red}{to-do}}} }

\newcommand{\dnote}[1]{\ifdebug \textcolor{blue}{\small (David: #1)} \fi}
\newcommand{\hnote}[1]{\ifdebug \textcolor{darkgreen}{\small (Honghao: #1)} \fi}
...
\newcommand{\corre}[1]{\left\langle#1\right\rangle}
